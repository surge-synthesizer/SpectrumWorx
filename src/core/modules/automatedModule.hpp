...
Plugins::AutomatedParameterValue internal2AutomatedValue(std::uint8_t parameterIndex,
                                                         ...
                                                         ModuleParameters const &);
float automated2InternalValue(std::uint8_t parameterIndex,
                              Plugins::AutomatedParameterValue automatedValue, bool normalised,
                              ModuleParameters const &);

Plugins::AutomatedParameterValue sharedInternal2AutomatedValue(std::uint8_t sharedParameterIndex,
                                                               float internalValue,
                                                               bool normalised);
float sharedAutomated2InternalValue(std::uint8_t sharedParameterIndex,
                                    Plugins::AutomatedParameterValue automatedValue,
                                    bool normalised);

Plugins::AutomatedParameterValue effectInternal2AutomatedValue(std::uint8_t effectParameterIndex,
                                                               float internalValue, bool normalised,
                                                               ModuleParameters const &);
float effectAutomated2InternalValue(std::uint8_t effectParameterIndex,
                                    Plugins::AutomatedParameterValue automatedValue,
...
template <class AutomatedParameter> class LFOParameterSetter : public AutomatedParameter::Setter
{
  public:
...
template <class AutomatedParameter> class LFOParameterGetter : public AutomatedParameter::Getter
{
  public:
    ...
    {
        result_type result(
            AutomatedParameter::template convertParameterToAutomationValue<LFO::PeriodScale>(
                parameter));
        if (AutomatedParameter::normalised)
                                                          ...
                                                          ModuleParameters const &module)
{
    ...
    return LE::Parameters::invokeFunctorOnIndexedParameter(
        module.lfo(parameterIndex).parameters(), lfoParameterIndex,
...
getDefaultAutomatedLFOParameter(std::uint8_t const lfoParameterIndex)
{
    ...
    return LE::Parameters::invokeFunctorOnIndexedParameter<LFO::Parameters const>(
        LFO::Parameters(), lfoParameterIndex, Detail::LFOParameterGetter<AutomatedParameter>());
}
